...
const docDefinition = {
	content: [
		{ text: 'Status: مكتمل - کامل - مکمل (Complete)', margin: [0, 10] },
		{
			...
			table: {
				supportRTL: true, // Enable automatic RTL support for the table
				headerRows: 2,
				widths: ['auto', '*', '*', '*', 'auto', '*'],
				body: [
					// Row 1 (main headers)
					...
					[
						...
						{ text: 'Status: مكتمل - کامل - مکمل (Complete)', style: 'tableHeader', alignment: 'center' },
						{}
					],
					// Data rows
					['1', 'أحمد', 'بن سالم', 'ثانوي', '15.2', 'طالب متميز يسعى للتفوق في دراسته ويحب القراءة والبحث العلمي. يتطلع لدراسة الهندسة والمساهمة في (خخذا)  في بلاده'],
					['2', 'سارة', 'محمد', 'إعدادي', '14.5', 'طالبة نشيطة تحب الرياضيات والعلوم وتشارك في الأنشطة المدرسية المختلفة. تهدف لأن تصبح (bonjour) معلمة لتساعد الأجيال القادمة على التعلم والنمو'],
					...
					['4', 'ليلى', ' < هذا >', '- ثانوي', '13.8', 'طالبة مجتهدة تحب الفنون والآداب وتشارك في الأنشطة الثقافية. تهدف لدراسة الأدب العربي والمساهمة في إثراء الثقافة العربية من خلال الكتابة والإبداع']
				]
			}
		}
	],
