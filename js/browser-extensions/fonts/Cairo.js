...
var fontContainer = {
  vfs: {
    'Cairo-Regular.ttf': {
      data: fs.readFileSync(__dirname + '/../../../fonts/Cairo/Cairo-Regular.ttf', 'base64'),
      encoding: 'base64'
    },
    'Cairo-Bold.ttf': {
      data: fs.readFileSync(__dirname + '/../../../fonts/Cairo/Cairo-Bold.ttf', 'base64'),
      encoding: 'base64'
    },
    'Cairo-Light.ttf': {
      data: fs.readFileSync(__dirname + '/../../../fonts/Cairo/Cairo-Light.ttf', 'base64'),
      encoding: 'base64'
    },
    'Cairo-SemiBold.ttf': {
      data: fs.readFileSync(__dirname + '/../../../fonts/Cairo/Cairo-SemiBold.ttf', 'base64'),
      encoding: 'base64'
    }
  },
  fonts: {
