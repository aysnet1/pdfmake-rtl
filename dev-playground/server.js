...
function createPdfBinary(docDefinition) {
	var fonts = {
		...
		Cairo: {
			normal: path.join(__dirname, '..', 'examples', '/fonts/Cairo-Regular.ttf'),
			bold: path.join(__dirname, '..', 'examples', '/fonts/Cairo-Bold.ttf'),
			italics: path.join(__dirname, '..', 'examples', '/fonts/Cairo-Light.ttf'),
			bolditalics: path.join(__dirname, '..', 'examples', '/fonts/Cairo-SemiBold.ttf')
		}
	};
